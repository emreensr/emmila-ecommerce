            ...
            <div class="bg-white p-5">
                <div v-if="selectedMenu === 1" class="space-y-3">
                    <div class="flex flex-col">
                        ...
                        <input class="px-3 py-2 border lg:w-1/2 w-full rounded-md" type="text" placeholder="Product Name" />
                    </div>
                    <div class="flex flex-col">
                ...
                <div v-if="selectedMenu === 3" class="space-y-3">
                    <div class="flex flex-col">
                        ...
                        <input class="px-3 py-2 border lg:w-1/2 w-full rounded-md" type="text" placeholder="Tax Excluded Price" />
                    </div>
                    <div class="flex flex-col">
                        <label class="pb-2">Tax Included Price</label>
                        <input class="px-3 py-2 border lg:w-1/2 w-full rounded-md" type="text" placeholder="Tax Included Price" />
                    </div>
                    <div class="flex flex-col">
